...
func (x *Student) GetGender() int64 {
	if x != nil {
		return x.Gender
	}
	return 0
...
func (x *Student) GetMoblie() string {
	if x != nil {
		return x.Moblie
	}
	return ""
...
func (x *GetStudentInfoReq) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetStudentInfoResp) GetStudent() *Student {
	if x != nil {
		return x.Student
	}
	return nil
...
var file_student_proto_rawDesc = []byte{
	...
	0x02, 0x70, 0x62, 0x22, 0x5d, 0x0a, 0x07, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x12, 0x0e,
	...
	0x69, 0x65, 0x22, 0x23, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74,
	...
	0x75, 0x64, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x25, 0x0a,
	...
	0x64, 0x65, 0x6e, 0x74, 0x32, 0x50, 0x0a, 0x0d, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x63,
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x3f, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64,
	0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74,
	0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x1a, 0x16,
	0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x49, 0x6e,
...
var file_student_proto_goTypes = []interface{}{
	...
	(*GetStudentInfoReq)(nil),  // 1: pb.GetStudentInfoReq
	(*GetStudentInfoResp)(nil), // 2: pb.GetStudentInfoResp
}
var file_student_proto_depIdxs = []int32{
	0, // 0: pb.GetStudentInfoResp.student:type_name -> pb.Student
	1, // 1: pb.studentcenter.GetStudentInfo:input_type -> pb.GetStudentInfoReq
	2, // 2: pb.studentcenter.GetStudentInfo:output_type -> pb.GetStudentInfoResp
